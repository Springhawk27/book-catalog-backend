...
const createBook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_service_1.BookService.createBook(bookData, userData);
...
const updateBook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_service_1.BookService.updateBook(id, req.body, userData);
    (0, sendresponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const deleteBook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const userData = __rest(req.user, []);
    const result = yield book_service_1.BookService.deleteBook(id, userData);
    (0, sendresponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
